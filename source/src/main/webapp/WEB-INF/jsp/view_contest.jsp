...
<body>
	...
	<main>
		...
		<div class="item">
			...
			<div class="info">
				<span class="votes">集計中</span>
			</div>
			
			<div class="grayimage"></div>
		...
		<div class="card">
			<form action="edit.html">
			    ...
			    <!-- <div class="menu-right">
				    ...
				    <div class="menu-info">
				        <span class="name">アボカドベーコン</span><br>
				        <span class="price">集計中</span>
				    </div>					
			    </div> -->
			</form>
	...
	<footer>
		<nav>
			<ul>
				<li><a href="/b1/home"> <img src="/b1/images/home.png"
						class="footer_icon"><br>ホーム
				</a></li>
