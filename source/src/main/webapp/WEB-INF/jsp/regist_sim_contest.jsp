...
<head>
    ...
    <title>FanTable │ コンテスト応募メニュー追加</title>
...
<main class="contestmenuregist">
        ...
        <form class="choice_material" method="post" action="/b1/contestregist" onsubmit="return validateForm();">        
            ...
            <div class="item_material">
                ...
                <input type="radio" name="patty1" value="3" id="patty1_beef" checked>
                    <label for="patty1_beef">ビーフ</label>

                <input type="radio" name="patty1" value="4" id="patty1_chicken">
            ...
            <div class="item_material">
                ...
                <input type="radio" name="topping1" value="7" id="topping1_egg">
            ...
            <h3>野菜1</h3>
                ...
                <input type="radio" name="vegetable1" value="10" id="vegetable1_onion">
            ...
            <div class="item_material">
                ...
                <input type="radio" name="vegetable2" value="9" id="vegetable2_tomato">
                    <label for="vegetable2_tomato">トマト</label>

                <input type="radio" name="vegetable2" value="10" id="vegetable2_onion">
            ...
            <div class="item_material">
                ...
                <input type="radio" name="patty3" value="4" id="patty3_chicken">
            ...
            <div class="item_material">
                ...
                <input type="radio" name="topping3" value="6" id="topping3_bacon">
                    <label for="topping3_bacon">ベーコン</label>

                <input type="radio" name="topping3" value="7" id="topping3_egg">
            ...
            <div class="item_material">
                ...
                <input type="radio" name="vegetable3" value="9" id="vegetable3_tomato">
                    <label for="vegetable3_tomato">トマト</label>

                <input type="radio" name="vegetable3" value="10" id="vegetable3_onion">
			...
			<div class="item_material">
                ...
                <input type="radio" name="sauce" value="13" id="sauce_mustard">
	...
	function validateForm() {
	    ...
	    return confirm("この内容でコンテストメニューを応募しますか？");
	}
</script>
