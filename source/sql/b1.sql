...
VALUES
    ...
    ('09012345678', 'pass1234', 'ミスターバーガー', 3, 'icons/user1.png', 5, 5),
    ('08023456789', 'burger99', 'バーガーマスター', 3, 'icons/user2.png', 12, 4),
    ('07034567890', 'cheese77', 'キングバーガー', 3, 'icons/user3.png', 8, 3),
    ('09045678901', 'meat555', 'バーガー太郎', 2, 'icons/user4.png', 20, 2),
    ('08056789012', 'bbq0000', 'チーズ花子', 1, 'icons/user5.png', 15, 1);
...
VALUES
    ...
    ('ヘルシーベジタブル', '', 1, 2, 0, 0, 0, 0, 6, 7, 9, 10, 8, 11, 520, 0),
    ...
    ('トマトエッグ', '', 1, 2, 3, 0, 0, 5, 7, 0, 9, 9, 0, 12, 650, 1),
    ('オニオンエッグベジサンド', '', 1, 2, 3, 3, 0, 5, 7, 5, 10, 0, 10, 11, 580, 0),
    ('アボカドチキンエッグ', '', 1, 2, 4, 0, 0, 9, 7, 0, 8, 6, 10, 11, 880, 1),
    ('オールスター全部のせ', '', 1, 2, 3, 4, 0, 8, 9, 10, 5, 6, 7, 11, 1400, 1),
    ('スタミナバーガー', '', 1, 2, 3, 4, 3, 8, 9, 0, 7, 0, 0, 12, 950, 1)
    ;
